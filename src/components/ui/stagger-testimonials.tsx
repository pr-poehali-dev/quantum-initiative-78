...
const testimonials = [
  {
    tempId: 0,
    testimonial:
      "Handball City — это семья. Когда я впервые пришёл на тренировку, меня приняли как своего. Уже через сезон я вышел в стартовом составе финала чемпионата города.",
