...
export default function Index() {
  const missionStatement =
    "Handball City — это больше, чем клуб. Это команда людей, объединённых страстью к гандболу и духом честной борьбы. Мы проводим городской чемпионат, растим новых чемпионов и открываем двери для каждого — от новичка до опытного игрока. Площадка — наш дом, мяч — наш язык, победа — наша цель. Присоединяйся к лучшему гандбольному клубу города и стань частью живой истории."
  ...
  const timelineEntries = [
    {
      ...
      description:
        "За сезон 2024 Алексей забил 47 голов и вывел команду в финал городского чемпионата. Начинал с детской секции, а сегодня — капитан и лицо клуба. Его подача с левого фланга стала фирменным знаком Handball City.",
    ...
    },
    {
      ...
      description:
        "Handball City — чемпион города 2023 и 2024 года. 18 игроков, 1 цель. Каждый матч — это история характера, дисциплины и командного духа. Хочешь стать частью этой истории? Площадка ждёт тебя.",
      layout: "left" as const,
    },
  ]
